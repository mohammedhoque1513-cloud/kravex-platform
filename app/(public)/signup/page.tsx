      ...
      <Section className="bg-kravex-black">
        <div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-[.9fr_1.1fr]">
          <div>
            ...
            <p className="mt-6 leading-7 text-kravex-secondary">Tell us about your business. You do not need an account yet. Once KRAVEX approves you as a client, Emdadul will create your secure portal login.</p>
            <div className="mt-6 rounded border border-kravex-border bg-black p-4 text-sm text-kravex-secondary">
              ...
              <p className="mt-2">Submit the form, we review fit, then you receive a client portal login only after onboarding.</p>
            </div>
          </div>
          <Card>
            <LeadCaptureForm />
