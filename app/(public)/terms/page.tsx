...
const terms = [
  ...
  ["Service scope", "KRAVEX provides lead generation strategy, campaign setup, lead capture, qualification, client portal access, reporting, invoicing and communication tools. Exact services, price, start date and lead criteria must be agreed before paid work begins."],
  ["No guaranteed sales", "KRAVEX may target qualified enquiries and improve pipeline visibility, but it does not guarantee closed sales, revenue, profit, finance approvals, legal case outcomes, treatment bookings or any specific return on investment."],
  ...
  ["Client duties", "Clients are responsible for responding quickly, giving accurate business information, holding required licences, complying with their own regulator, keeping portal credentials secure and using delivered leads lawfully."],
  ["Regulated sectors", "KRAVEX does not provide legal advice, medical advice, dental advice, financial advice, mortgage advice or insurance advice. For solicitors, financial services, mortgage brokers, healthcare, dentistry and aesthetics, the regulated business remains responsible for compliance and client advice."],
  ...
  ["Payments and VAT", "Fees are payable by the due date on the invoice. Money vaults are internal ledger categories, not bank accounts. VAT should only be charged where KRAVEX is VAT registered or otherwise legally required to account for VAT."],
  ...
  ["Liability", "Nothing in these terms excludes liability that cannot legally be excluded. Subject to that, KRAVEX is not responsible for a client's sales process, pricing, availability, reputation, regulatory compliance or failure to follow up leads."],
  ...
  return (
    <PublicShell>
      <Section className="bg-kravex-black">
        <p className="text-xs font-bold uppercase tracking-[.3em] text-kravex-gold">Legal</p>
        ...
        <p className="mt-6 max-w-3xl leading-8 text-kravex-secondary">
          These terms set the legal boundaries for KRAVEX lead generation services. A signed client agreement
        ...
        <Card className="mt-8 border-kravex-gold/40 bg-black">
          <h2 className="font-heading text-2xl">Important legal note</h2>
          <p className="mt-3 leading-7 text-kravex-secondary">
            This page is a strong operating baseline, not solicitor-drafted legal advice. Before taking substantial
            client payments, KRAVEX should have a UK solicitor review the final terms, privacy policy, processor contracts
