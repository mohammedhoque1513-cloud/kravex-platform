...
const sections = [
  ...
  ["What we collect", "We collect enquiry details, business contact details, phone numbers, email addresses, campaign notes, lead status, invoice records, payment references, dashboard messages, security logs and form metadata such as source and IP address."],
  ["Why we use it", "Data is used to respond to enquiries, assess whether KRAVEX can help a business, manage client lead campaigns, deliver dashboard access, issue invoices, detect fraud, protect the platform and meet accounting or lawful obligations."],
  ["Lawful bases", "KRAVEX may rely on contract, legitimate interests, consent where required, and lawful obligation. Direct marketing will only be sent where there is a lawful basis and, where PECR requires it, consent or a valid soft opt-in."],
  ...
  ["Retention", "Enquiries that do not become clients should be reviewed and deleted or anonymised when no longer needed. Client, invoice, payment and accounting records may be retained for longer where required for lawful, tax, dispute or audit purposes."],
  ...
  ["Security", "KRAVEX uses role-based access, authentication, rate limits, security logs, encrypted secrets, HTTPS, input validation and restricted admin/client dashboards. No online platform can be guaranteed risk-free."],
    ...
    <PublicShell>
      <Section className="bg-kravex-black">
        ...
        <p className="mt-6 max-w-3xl leading-8 text-kravex-secondary">
          This policy explains how KRAVEX handles personal data for enquiries, lead generation, client dashboards,
